...
const openai_key = "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";
  ...
  try {
    ...
    const completion = await client.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are a data analyst that provides concise, bullet-point insights about data visualization. Focus on patterns, trends, anomalies, and actionable insights. Keep your analysis to 3-5 short bullet points, starting each with a bullet point character '•'."
        },
        {
          role: "user",
