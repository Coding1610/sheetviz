  ...
  return (
    <div className="hero-gradient min-h-[90vh] flex flex-col justify-center items-center px-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-full h-full overflow-hidden">
        <div className="absolute top-10 right-10 w-64 h-64 bg-brand-purple-light/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 left-10 w-64 h-64 bg-brand-purple/20 rounded-full blur-3xl"></div>
      </div>
      
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-brand-purple-700 to-brand-purple animate-fade-in">
          SheetViz
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: "0.4s" }}>
          {isSignedIn ? (
            <Link to="/dashboard">
              <Button size="lg" className="bg-brand-purple hover:bg-brand-purple-600 text-white px-8 py-6 rounded-md">
                Go to Dashboard
              </Button>
            </Link>
          ) : (
